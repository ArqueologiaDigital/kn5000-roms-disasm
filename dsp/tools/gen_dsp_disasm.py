...
#  emit one listing
# --------------------------------------------------------------------------
# No license/copyright header on the disassembled OUTPUT: this listing is a
# reverse-engineered view of the ORIGINAL KN5000 effects-DSP microcode, not an
# original work of authorship.  A neutral provenance note goes in its place.
PROVENANCE = [
