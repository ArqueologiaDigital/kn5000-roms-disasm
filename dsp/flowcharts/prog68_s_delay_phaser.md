...
Per-instruction detail: [`../disasm/prog68_s_delay_phaser.dsm`](../disasm/prog68_s_delay_phaser.dsm). Confidence legend and method: [`README.md`](README.md). Narrative: the MAME development blog, KN5000 effects-DSP series (Parts 78-84). Reference: the project docs site, `/effects-dsp/`.
