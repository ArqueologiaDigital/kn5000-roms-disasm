...
typedef struct __attribute__((packed)) {
    ...
    uint32_t ptr_3016;
    char str_311[6];
    naka_container_t w159;  /* NAKA_TYPE_CONTAINER */
    char w159_text[16];
...
_Static_assert(sizeof(naka_composer_style_t) == 12378,
    "naka_composer_style must be exactly 12378 bytes");
