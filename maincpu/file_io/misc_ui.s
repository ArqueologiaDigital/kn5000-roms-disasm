...
LABEL_F954A7:
	ld xwa, (xsp + 10)
	x_dri5_o00_t1 0x07, 0xE0, 0xE8, 0x00
	lds hl, 0
	ld de, (xsp + 2)
	inc 1, bc
	cp bc, de
...
LABEL_F95657:
	ld_sril3 XWA, 0xFD, 0xAA, 0x00
	ld_sril3 XBC, 0xFD, 0xA6, 0x00
	ld_sril3 XDE, 0xFD, 0xA2, 0x00
	jrl LABEL_F95ABF
