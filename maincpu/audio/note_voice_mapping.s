...
__jrt_nop_FE9709_Data:
	.byte 0x01, 0x02, 0x01, 0x02, 0x01, 0x01, 0x02, 0x01, 0x02, 0x01, 0x02, 0x01, 0x01, 0x02
	halt
	.byte 0x06
...
__jrt_nop_FEA344_Data:
	...
	ccf
	zcf
	.byte 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c
	call	2105118
	.byte 0x21
	.asciz "\"#$%&'()* "
	ld	xwa, 0x00008000
...
SendPartDataBlock_Data:
	...
	ld	(xbc+76), a
	incm8	1, (xsp+4)
	.byte 0x9f, 0x06, 0x38, 0x51, 0x00, 0x9f, 0x08, 0x38, 0x3e, 0x00, 0x8f, 0x04, 0x3f, 0x04
	jrl	c, -444
	pop	xiz
	lda	xsp, (xsp+10)
	ret
	...
	ld	c, (xwa+18)
	and	c, 240
	.byte 0xc7, 0xf0, 0x9b, 0xcb, 0xef, 0x04
	extz	bc
	lda_24	xhl, 15652237
	.byte 0xc3, 0x07, 0xec, 0xe4, 0x23, 0xc7, 0xf0, 0x9b, 0xc7, 0xf0, 0x8c, 0xcc, 0xee, 0x06
	ld	e, (xwa+19)
	ld	c, e
	and	c, 240
	.byte 0xc7, 0xf0, 0x9b, 0xcb, 0xef, 0x04
	extz	bc
	.byte 0xc3, 0x07, 0xec, 0xe4, 0x23, 0xc7, 0xf0, 0x9b, 0xcb, 0xee, 0x04
	or	d, c
	and	e, 15
	.byte 0xc7, 0xf0, 0x9d, 0xc7, 0xf0, 0x8b
	extz	bc
	.byte 0xc3, 0x07, 0xec, 0xe4, 0x23, 0xc7, 0xf0, 0x9b, 0xcb, 0xee, 0x02
	or	d, c
	ld	(xwa+17), d
	lda	xbc, (xwa+20)
	ld	xde, xbc
	...
	lda	xix, (xde+345)
	ldw	bc, 40
	.byte 0x95, 0x11, 0x85, 0x10, 0xf3, 0xfd, 0xaa, 0x01, 0x37
	ret
	lda	xsp, (xsp-26)
	push	xiz
	ld	(xsp+22), xbc
