...
FileIO_BytecodeData:
	...
	ld	xwa, xhl
	cpl	wa
	.byte 0xd7, 0xe2, 0x06, 0xe1, 0x84, 0x8e, 0xc8
	ldda32	xwa, 36488
	and	xwa, xhl
	jr	z, 2
	.byte 0xb1, 0xb9
	...
	ld	xwa, xhl
	cpl	wa
	.byte 0xd7, 0xe2, 0x06, 0xe1, 0x88, 0x8e, 0xc8
	ldda32	xwa, 36484
	and	xwa, xhl
	jr	z, 2
	.byte 0xb1, 0xb8
...
TempoCC_TransmitBytecodeBlock:
	...
	ldda32	xiy, 37106
	extz	wa
	.byte 0xd8, 0xee, 0x02, 0xe3, 0x07, 0xf4, 0xe0, 0x25
	ld	wa, (xiy)
	bit	7, a
	jr	z, 7
	res	7, a
...
VoiceMode_ParamConfigTables:
	...
	.byte 0x01, 0x7f, 0x01
	.fill 8, 1, 0xff
	.byte 0xb4, 0x02, 0x7f, 0x06, 0xb1, 0x02, 0x7f, 0x03, 0xb2, 0x02, 0x7f, 0x04, 0xb3, 0x02, 0x7f, 0x05, 0x02
	nop
	swi	7
	nop
	.byte 0x02, 0x03
	...
	jrl	nc, 769
	ldio	127, 1
	.byte 0x03, 0x0b, 0x7f, 0x01, 0x03
	ldwio	255, 769
	.byte 0x09, 0x7f, 0x01, 0xad, 0x03, 0x7f, 0x01, 0xae, 0x03, 0x7f, 0x01
	swi	7
	swi	7
	swi	7
	swi	7
	...
	jrl	nc, 1025
	ldio	127, 1
	.byte 0x04, 0x0b, 0x7f, 0x01, 0x04
	ldwio	255, 1025
	.byte 0x09, 0x7f, 0x01, 0xad, 0x04, 0x7f, 0x01, 0xae, 0x04, 0x7f, 0x01
	.fill 8, 1, 0xff
	.byte 0xb4, 0x05
	jrl	nc, -20218
	halt
	...
	jrl	nc, 1537
	ldwio	255, 1537
	.byte 0x09, 0x7f, 0x01, 0xad, 0x06, 0x7f, 0x01, 0xae, 0x06, 0x7f, 0x01
	.fill 8, 1, 0xff
	.byte 0xb4, 0x07
	jrl	nc, -20218
	reti
	...
	jrl	nc, 2305
	ldwio	255, 2305
	.byte 0x09, 0x7f, 0x01, 0xad, 0x09, 0x7f, 0x01, 0xae, 0x09, 0x7f, 0x01
	swi	7
	swi	7
	swi	7
	swi	7
	...
	ldw	wa, 18433
	ldio	255, 2
	.byte 0x90, 0x00, 0x1f, 0x01, 0x90, 0x01, 0x1f, 0x01, 0x90, 0x03, 0x02, 0x01
	jr	f, 1
	.byte 0xc0, 0x01, 0x70
	nop
	reti
	.byte 0x01
	jrl	f, -254
	.byte 0x01, 0x98, 0x0b, 0xc0, 0x01, 0x98, 0x01, 0x7f, 0x01, 0x98, 0x02, 0x80, 0x01, 0x98, 0x03, 0x01, 0x01, 0xb0, 0x01
	jrl	nc, 4101
	.byte 0x03
	swi	7
	.byte 0x01
	...
	swi	4
	nop
	.byte 0x2f, 0xc4, 0xfc, 0x00
	jp	64708
	.byte 0x2f, 0xc3, 0xfc, 0x00
	pop	xsp
	.byte 0xc3, 0xfc, 0x00
	cp	(xsp-61), d
	nop
	...
	ei	0x9a
	ldwio	255, 39430
	.byte 0x0b, 0xff, 0x06, 0x9a, 0x0c, 0xff
	ei	0x9a
	decf
	swi	7
	ei	0x9a
	...
	.byte 0x09, 0x7f
	ei	0xad
	.byte 0x09, 0x7f, 0x03, 0xae, 0x09, 0x7f, 0x04
	.fill 8, 1, 0xff
	ldwio	3, 1535
	ldwio	4, 1608
	ldwio	5, 1663
	...
	.byte 0x09, 0x7f
	ei	0xad
	.byte 0x0b, 0x7f, 0x03, 0xae, 0x0b, 0x7f, 0x04
	.fill 8, 1, 0xff
	incf
	.byte 0x03
	swi	7
	...
	swi	7
	ei	0x98
	.byte 0x0b, 0xc0, 0x06, 0x98, 0x01, 0x7f
	ei	0x98
	.byte 0x02, 0x80, 0x06, 0x98, 0x03, 0x01
	ei	0x10
	.byte 0x03
	swi	7
	ei	0x11
...
MidiStream_DispatchData:
	...
	set	7, e
	ld	xix, 38002
	.byte 0xca, 0xee, 0x01, 0xf3, 0x03, 0xf0, 0xe5, 0x52
	ret
	calr	1257
	ret
	cp	b, 31
...
MidiStream_ExtendedDispatch:
	...
	.byte 0xcf, 0xec, 0x02
	ld	xix, 16567183
	.byte 0xe3, 0x03, 0xf0, 0xec, 0x24, 0xb4, 0xe8
	ret
	calr	-114
	ret
	cp	(xsp-53), ix
	...
	and	wa, 32639
	.byte 0xf3, 0x07, 0xf0, 0xec, 0x50, 0xdb, 0xef, 0x01
	ldda8	b, 64848
	and	b, 3
	.byte 0xca, 0xee, 0x02
	ld	xiy, 16567843
	.byte 0xe3, 0x03, 0xf4, 0xe5, 0x25, 0xb5, 0xd8
	ldw	hl, 64718
	nop
	ldw	iy, 64718
	nop
...
MidiStream_HandleRunningStatus:
	...
	.byte 0xdb, 0xee, 0x02
	ld	xix, 16567946
	.byte 0xe3, 0x03, 0xf0, 0xec, 0x24, 0xb4, 0xd8
	ret
	cp	(xde-50), ix
	nop
	.byte 0xb8, 0xce, 0xfc
