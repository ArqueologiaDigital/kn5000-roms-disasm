...
HDAE5000_Init_BytecodeBlock:
	...
	cp	hl, 65535
	jr	nz, 10
	.byte 0xf2, 0x04, 0x00, 0x16, 0xbb, 0xc7, 0xfb, 0xa9
	jr	8
	.byte 0xc7, 0xfb, 0xd9
	jr	nz, 5
	pop qiz
	...
	.byte 0xf2, 0x04, 0x00, 0x16, 0xb8
	calr	-484
	.byte 0xf2, 0x04, 0x00, 0x16, 0xb0, 0xf2, 0x04, 0x00, 0x16, 0xb9, 0x0b, 0x03, 0x00
	ld	xwa, 8388608
	ld	xbc, 2621440
	lds	de, 0
	calr	-562
	or	xhl, xhl
	.byte 0xf2, 0x90, 0x48, 0xef, 0xee, 0x0b, 0x01, 0x00
	ld	xwa, 3145728
	ld	xbc, 2097152
	lds	de, 0
	calr	-587
