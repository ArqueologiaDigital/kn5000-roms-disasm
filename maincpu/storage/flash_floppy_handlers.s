...
FlashWrite_BlockData_Type5:
	...
	nop
	ldb	w, 12
	.byte 0x0b, 0x02, 0x05, 0x0b, 0x62, 0x06
	swi	7
	nop
	ldb	w, 99
	decf
...
DrumDetailEdit_Menu_Table:
	...
	add	(xix+35), xiz
	ei	0x05
	.byte 0xb1, 0x23, 0x8e, 0x22, 0x0a, 0x0b, 0x00, 0x38
	nop
	.byte 0x9c, 0x00, 0x8a
	nop
	ldb	b, 10
...
PartGrid_OperationsBlock:
	...
	jr	z, 64
	.byte 0x8f, 0x08, 0x3f, 0x03
	jr	z, 48
	.byte 0x8f, 0x08, 0x3f, 0x02
	jr	z, 32
	.byte 0x8f, 0x08, 0x3f, 0x01
	jr	z, 16
	.byte 0x8f, 0x08, 0x3f, 0x00
	jr	nz, 54
	ld	(xbc+24), e
...
Flash_ExtendedOpsBlock:
	...
	ldb	h, 0
	ldb	l, 0
	.byte 0xc7, 0xea, 0xa8, 0xc7, 0xea, 0x89
	extz	wa
	add	wa, wa
	inc	2, wa
	...
	cp	l, 40
	jr	c, -79
	.byte 0xc7, 0xea, 0x61, 0xc7, 0xea, 0xcf, 0x32
	jr	c, -113
	popw	iz
	inc	2, xsp
	ret
...
Flash_SlotUpdateOpsBlock:
	...
	inc	2, wa
	ldada	xbc, 3074
	.byte 0xf3, 0x07, 0xe4, 0xe0, 0x02, 0x01, 0x00, 0xc7, 0xfa, 0x61, 0xc7, 0xfa, 0xdc
	jr	ule, -55
	.byte 0xc7, 0xfb, 0x61, 0xc7, 0xfb, 0xcf, 0x0a
	jr	c, -82
	.byte 0xd7, 0xfa, 0x05
	...
	inc	6, ix
	add	bc, 108
	.byte 0xd3, 0x07, 0xec, 0xe4, 0x20, 0xf3, 0x07, 0xe8, 0xf0, 0x50, 0xc7, 0xe2, 0x61, 0xc7, 0xe2, 0xcf, 0x32
	jr	c, -65
	ld	a, (xsp)
	extz	wa
	calr	-4264
	...
	.byte 0x80, 0x3f, 0x48
	jrl	nz, 279
	.byte 0x88, 0x01, 0x3f, 0x00
	jrl	nz, 272
	.byte 0x88, 0x02, 0x3f, 0x4b
	jrl	nz, 265
	calr	-7620
	ldda32	xwa, 3186
	ld	xbc, (xsp+70)
