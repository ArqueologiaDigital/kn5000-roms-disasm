...
FDC_Send_Command:
	st8_24	1114120, a
	ret
	.byte 0xc1, 0x22, 0x8b, 0x19, 0x20, 0x8b
	stda8	35618, a
	ret
...
FDC_SeekRecalibrate:
	...
	cpda8	a, 35588
	ret	z
	.byte 0xc1, 0x36, 0x8a, 0x19, 0x04, 0x8b
	lds	wa, 2
	calr	-153
	calr	-210
	ldw	wa, 15
...
FDC_CMD_EXEC:
	...
	jrl	259
	ldda16	wa, 35400
	.byte 0xd1, 0x0c, 0x8b, 0xf0
	jr	ule, 6
	stdi16	35400, 1
	.byte 0xd1, 0x48, 0x8a, 0x19, 0x10, 0x8b
	stdi16	35356, 0
	cpdi8	35436, 2
	jr	nz, 8
	stdi16	35358, 1024
	jr	6
	stdi16	35358, 512
	.byte 0xd1, 0x4a, 0x8a, 0x19, 0x12, 0x8b
	lds	iz, 1
	ldda16	wa, 35358
	...
	jr	-38
	stda16	35402, iz
	.byte 0xd1, 0x10, 0x8b, 0x19, 0x48, 0x8a
	calr	-211
	cpdi8	35364, 0
	jr	z, 58
	cpdi8	35364, 9
	...
	stdi8	35588, 255
	calr	-302
	.byte 0xd1, 0x12, 0x8b, 0x19, 0x4a, 0x8a
	decdi8	1, 35432
	ldda8	a, 35432
	cps	a, 0
	jr	nz, 84
...
FDC_MODE_CONFIG:
	...
	stdi8	35369, 0
	jr	54
	.byte 0xc1, 0x36, 0x8a, 0x19, 0x12, 0x8a
	calr	76
	cpdi8	35364, 0
	jr	nz, 50
	ldda8	a, 35369
...
FDC_STATUS_COPY:
	.byte 0xc1, 0x26, 0x8a, 0x19, 0x24, 0x8a
	ret
	ldda16	wa, 35396
	cps	wa, 1
	jr	z, 13
...
FDC_INTERRUPT_HANDLER:
	...
	ldw	wa, 50
	calr	-1793
	.byte 0xc7, 0xfb, 0x33, 0x05
	jr	nz, 6
	ldw	wa, 49
	calr	-1805
	.byte 0xc7, 0xfb, 0x33, 0x06
	jr	z, 6
	ldw	wa, 47
	calr	-1817
	pop qiz
