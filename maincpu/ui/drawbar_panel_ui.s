...
PmemOutLGridCheck_JumpTable:
	...
	extz	wa
	pushw	wa
	.byte 0x0b, 0xe8, 0x00, 0x0b, 0x50, 0x01
	lda	xwa, (xsp+50)
	push	xwa
	call	16714354
	lda	xsp, (xsp+10)
	...
	extz	wa
	pushw	wa
	.byte 0x0b, 0xe8, 0x00, 0x0b, 0x56, 0x01
	lda	xwa, (xsp+50)
	push	xwa
	call	16714354
	lda	xsp, (xsp+10)
	...
	jr	z, 18
	.byte 0x0b, 0xe8, 0x00, 0x0b, 0x5c, 0x01
	lda	xwa, (xsp+48)
	push	xwa
	call	16715597
	inc	8, xsp
	...
	extz	wa
	pushw	wa
	.byte 0x0b, 0xe8, 0x00, 0x0b, 0x62, 0x01
	lda	xwa, (xsp+50)
	push	xwa
	call	16714354
	lda	xsp, (xsp+10)
	...
	.byte 0xb0, 0xcf
	jr	z, 15
	.byte 0x0b, 0xe8, 0x00, 0x0b, 0x74, 0x01
	push	xbc
	call	16715597
	inc	8, xsp
	jr	19
	...
	extz	wa
	pushw	wa
	.byte 0x0b, 0xe8, 0x00, 0x0b, 0x80, 0x01
	lda	xwa, (xsp+50)
	push	xwa
	call	16714354
	lda	xsp, (xsp+10)
	...
	extz	wa
	pushw	wa
	.byte 0x0b, 0xe8, 0x00, 0x0b, 0x8c, 0x01
	lda	xwa, (xsp+50)
	push	xwa
	call	16714354
	lda	xsp, (xsp+10)
	...
	bit	7, wa
	jr	z, 18
	.byte 0x0b, 0xe8, 0x00, 0x0b, 0x92, 0x01
	ld	xwa, (xsp+16)
	push	xwa
	call	16715597
	inc	8, xsp
	jr	18
	push	xwa
	.byte 0x0b, 0xe8, 0x00, 0x0b, 0x98, 0x01
	ld	xwa, (xsp+20)
	push	xwa
	call	16714354
	lda	xsp, (xsp+12)
	...
	ld	xwa, (xwa)
	push	xwa
	.byte 0x0b, 0xe8, 0x00, 0x0b, 0x9e, 0x01
	ld	xwa, (xsp+20)
	push	xwa
	call	16714354
	lda	xsp, (xsp+12)
	...
	jr	18
	push	xwa
	.byte 0x0b, 0xe8, 0x00, 0x0b, 0xaa, 0x01
	ld	xwa, (xsp+20)
	push	xwa
	call	16714354
	lda	xsp, (xsp+12)
...
MidiPartGridCheck_JumpTable:
	...
	inc	1, wa
	pushw	wa
	.byte 0x0b, 0xe8, 0x00, 0x0b, 0xc0, 0x06
	lda	xwa, (xsp+30)
	push	xwa
	call	16714354
	lda	xsp, (xsp+10)
	...
	jr	nz, 18
	.byte 0x0b, 0xe8, 0x00, 0x0b, 0xc8, 0x06
	ld	xwa, (xsp+12)
	push	xwa
	call	16715597
	inc	8, xsp
	...
	inc	1, hl
	pushw	hl
	.byte 0x0b, 0xe8, 0x00, 0x0b, 0xce, 0x06
	lda	xwa, (xsp+30)
	push	xwa
	call	16714354
	lda	xsp, (xsp+10)
...
AudioCtrl_DataBlock:
	...
	ldw	de, 255
	call	16427402
	.byte 0x9f, 0x0c, 0x38, 0x25, 0x00, 0x9f, 0x08, 0x38, 0x25, 0x00
	inc	1, iz
	cps	iz, 7
	jr	lt, -46
	pop	xiz
	...
	lds32	xhl, 3
	push	xhl
	.byte 0x0b, 0xff, 0x00, 0x0b, 0xf2, 0x00, 0x0b, 0x00, 0x00, 0x0b, 0x00, 0x00
	jr	15
	lds32	xhl, 3
	push	xhl
	.byte 0x0b, 0xff, 0x00, 0x0b, 0x08, 0x00, 0x0b, 0x00, 0x00, 0x0b, 0x00, 0x00
	call	16437380
	jrl	193
	ld	wa, (xsp+12)
	calr	-930
	...
	lds32	xhl, 3
	push	xhl
	.byte 0x0b, 0x00, 0x00, 0x0b, 0x07, 0x00, 0x0b, 0x00, 0x00, 0x0b, 0x01, 0x00
	jr	15
	lds32	xhl, 3
	push	xhl
	.byte 0x0b, 0x00, 0x00, 0x0b, 0x07, 0x00, 0x0b, 0x00, 0x00, 0x0b, 0x00, 0x00
	call	16437380
	lda	xwa, (xsp+62)
	lda	xbc, (xsp+58)
	ld	de, (xsp+12)
	...
	add	(xhl), wa
	ld	wa, (xde)
	.byte 0xd8, 0xed, 0x03, 0xd8, 0xec, 0x02
	exts	xwa
	add	xwa, xbc
	ld	wa, (xwa+2)
	add	(xhl+2), wa
	...
	calr	-4042
	lda	xwa, (xsp+60)
	.byte 0x90, 0x3a, 0x0c, 0x00, 0x98, 0x02, 0x3a, 0x13, 0x00
	lds32	xbc, 2
	call	16432188
	ldw	wa, 128
	.byte 0x9f, 0x34, 0xa0
