...
Data_InOutGridDispatch:
	...
	exts	wa
	pushw	wa
	.byte 0x0b, 0xe7, 0x00, 0x0b, 0xfe, 0xfc
	lda	xwa, (xsp+18)
	push	xwa
	call	16714354
	lda	xsp, (xsp+10)
	jr	16
	.byte 0x0b, 0xe7, 0x00, 0x0b, 0x04, 0xfd
	lda	xwa, (xsp+16)
	push	xwa
	call	16715597
	inc	8, xsp
	...
	cps	hl, 2
	jr	nz, 22
	.byte 0x9e, 0x04, 0x04, 0x0b, 0xe7, 0x00, 0x0b, 0x0a, 0xfd
	lda	xwa, (xsp+18)
	push	xwa
	call	16714354
	lda	xsp, (xsp+10)
	jr	16
	.byte 0x0b, 0xe7, 0x00, 0x0b, 0x10, 0xfd
	lda	xwa, (xsp+16)
	push	xwa
	call	16715597
	inc	8, xsp
	...
	ld	bc, (xiz+4)
	.byte 0xd9, 0xec, 0x02, 0xe3, 0x07, 0xec, 0xe4, 0x20
	push	xwa
	push	xde
	call	16715597
	inc	8, xsp
...
Data_ParaLoadOptDispatch:
	...
	cps	hl, 0
	jrl	nz, 480
	.byte 0xb0, 0x02, 0x03, 0x00, 0x0b, 0xe7, 0x00, 0x0b, 0x16, 0xfd
	lda	xwa, (xsp+16)
	push	xwa
	call	16715597
	inc	8, xsp
	...
	exts	hl
	pushw	hl
	.byte 0x0b, 0xe7, 0x00, 0x0b, 0x1c, 0xfd
	lda	xwa, (xsp+18)
	push	xwa
	call	16714354
	lda	xsp, (xsp+10)
	...
	call	16569399
	pushw	hl
	.byte 0x0b, 0xe7, 0x00, 0x0b, 0x22, 0xfd
	lda	xwa, (xsp+18)
	push	xwa
	call	16714354
	lda	xsp, (xsp+10)
	...
	cps	hl, 0
	jrl	nz, 322
	.byte 0x0b, 0xe7, 0x00, 0x0b, 0x28, 0xfd
	lda	xwa, (xsp+16)
	push	xwa
	call	16715597
	inc	8, xsp
	...
	exts	hl
	pushw	hl
	.byte 0x0b, 0xe7, 0x00, 0x0b, 0x2e, 0xfd
	lda	xwa, (xsp+18)
	push	xwa
	call	16714354
	lda	xsp, (xsp+10)
	...
	call	16569399
	pushw	hl
	.byte 0x0b, 0xe7, 0x00, 0x0b, 0x34, 0xfd
	lda	xwa, (xsp+18)
	push	xwa
	call	16714354
	lda	xsp, (xsp+10)
