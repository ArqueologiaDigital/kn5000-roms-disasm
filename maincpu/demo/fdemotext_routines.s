...
FDemoText_ByteData_LayoutEngine:
	...
	ld	(xsp+140), xbc
	ld	(xsp+144), wa
	.byte 0xbf, 0x04, 0x02, 0x00, 0x00, 0xd3, 0xfd, 0x90
	...
	.byte 0x85, 0x10
	lds	iz, 0
	.byte 0xd3, 0xfd, 0x12, 0x01, 0x3f, 0x00, 0x00, 0x61
	.byte 0x7b, 0xf3, 0xfd, 0xca, 0x00, 0x32, 0xf3, 0xfd
	.byte 0x88, 0x00, 0x30
	push xwa
	ld	wa, iz
	ld	xbc, (xsp+274)
	...
	ld	bc, qiz
	sla	bc, 2
	.byte 0xf2, 0xc2, 0xfe, 0xe9, 0x30, 0xe3, 0x07, 0xe0
	.byte 0xe4, 0x21
	cp	(xbc), 0
	.byte 0x6e, 0xa8
	inc	1, iz
	...
	.byte 0x0c, 0x01, 0x3f, 0x00, 0x00, 0x6e, 0x16
	ld	xwa, xbc
	cp	(xbc), 0
