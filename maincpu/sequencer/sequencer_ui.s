...
IvNamingExit_ScreenData:
	...
	cp	wa, bc
	jrl	ge, 238
	.byte 0xf3, 0xfd, 0x9a, 0x00, 0x31, 0xe3, 0xfd, 0xb2, 0x00, 0x20
	call	16356829
	.byte 0xf3, 0xfd, 0x9a, 0x00, 0x31
	lda	xwa, (xbc+4)
	ld	(xsp+18), xwa
	...
	lda	xhl, (xbc+28)
	lda	xbc, (xsp+166)
	.byte 0xf3, 0xfd, 0x9a, 0x00, 0x30, 0x94, 0xf5
	jr	nz, 11
	ld	xhl, (xhl)
	push	xhl
	pushw 0
...
TrAsGridChk_ByteData:
	...
	calr	-218
	stda8	10355, l
	.byte 0xf2, 0x82, 0x10, 0x02, 0x14, 0x73, 0x28
	ld	xwa, 21430300
	ld	xbc, 31916038
	ld	xde, xiz
	call	16403043
...
NoteEditBox_EventDispatch2:
	...
	call	16402871
	ld	(xsp+8), hl
	.byte 0xbf, 0x0a, 0x02, 0x01, 0x00, 0xc7, 0xfb, 0xa8, 0xc7, 0xfb, 0x89
	extz	wa
	add	wa, wa
	lda_24	xbc, 14890936
	...
	ld	(xsp+4), xwa
	lda	xwa, (xsp+28)
	.byte 0xb8, 0x02, 0x02, 0x20, 0x00, 0xb8, 0x06, 0x02, 0x2b, 0x00, 0xc7, 0xfb, 0xd8
	jr	nz, 10
	...
	ld	(xsp+4), xwa
	lda	xwa, (xsp+28)
	.byte 0xb8, 0x02, 0x02, 0x21, 0x00, 0xb8, 0x06, 0x02, 0x2a, 0x00, 0x9f, 0x0a, 0x04, 0x0b, 0xe3, 0x00, 0x0b, 0x1c, 0x46
	lda	xwa, (xsp+42)
	push	xwa
	call	16714354
	lda	xsp, (xsp+10)
	...
	lds32	xwa, 0
	ld	(xsp+4), xwa
	.byte 0xb1, 0x02, 0x26, 0x00, 0xb4, 0x02, 0x31, 0x00, 0xc7, 0xfb, 0xd8
	jr	nz, 10
	.byte 0x9f, 0x08, 0x04
	ld	xwa, 14894624
	jr	21
	...
	lds32	xwa, 3
	ld	(xsp+4), xwa
	.byte 0xb1, 0x02, 0x28, 0x00, 0xb4, 0x02, 0x31, 0x00, 0x9f, 0x0a, 0x04, 0x0b, 0xe3, 0x00, 0x0b, 0x28, 0x46
	push	xde
	call	16714354
	lda	xsp, (xsp+10)
	incm	1, (xsp+10)
...
Sqedt_ParamDispatch:
	...
	ld	xwa, 14895960
	jr	42
	.byte 0xd1, 0xdc, 0xf1, 0x04, 0x40
	.long LABEL_E34B5E
	jr	31
	.byte 0xd1, 0xf2, 0xf1, 0x04
	ld	xwa, 14895972
	jr	20
	.byte 0xd1, 0x29, 0xf2, 0x04
	ld	xwa, 14895978
	jr	9
	.byte 0xd1, 0x06, 0x26, 0x04
	ld	xwa, 14895984
	jrl	1151
	ld	xwa, (xsp+8)
	ld	(xsp+4), xwa
	...
	ld	xwa, 14895996
	jr	53
	.byte 0xd1, 0x2c, 0x26, 0x04
	ld	xwa, 14896002
	jr	42
	.byte 0xd1, 0x26, 0x26, 0x04, 0x40
	.long NakaInst_3d
	jr	31
	.byte 0xd1, 0xfc, 0x25, 0x04
	ld	xwa, 14896014
	jr	20
	.byte 0xd1, 0xfa, 0x25, 0x04
	ld	xwa, 14896020
	jr	9
	.byte 0xd1, 0x08, 0x26, 0x04
	ld	xwa, 14896026
	jrl	1031
	ld	xwa, (xsp+8)
	ld	(xsp+4), xwa
