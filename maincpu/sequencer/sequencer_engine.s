...
NotePool_DataBlock:
	.byte 0xd7, 0xfa, 0x04, 0xc7, 0xfb, 0xa8, 0xc7, 0xfb, 0x8b
	inc	1, c
	extz	bc
	lds	wa, 0
	calr	13006
...
SeqPos_DataBlock:
	...
	cpdi8	10362, 0
	jr	z, 7
	.byte 0xc1, 0x33, 0x04, 0x19, 0x5a, 0x26
	ret
	.byte 0xc1, 0x8e, 0x28, 0x19, 0x5a, 0x26
	ret
...
SeqPart_PositionUpdateBlock:
	.byte 0xd7, 0xfa, 0x04, 0xd1, 0x31, 0xf2, 0x19, 0xcc, 0x26
	stdi8	10362, 0
	.byte 0xc7, 0xfb, 0xa9
	cpdi8	10401, 1
	jrl	c, 186
	...
	jrl	151
	calr	-1013
	.byte 0xd1, 0x86, 0x26, 0x19, 0x7f, 0x28
	ldda8	a, 9780
	.byte 0xc7, 0xfb, 0x99
	extz	wa
	extz	hl
	...
	stdi8	10362, 0
	jr	89
	.byte 0xd1, 0x32, 0x26, 0x19, 0x7f, 0x28
	ldda8	l, 10381
	ldda8	a, 9780
	.byte 0xc7, 0xfb, 0x99
	extz	wa
...
SeqData_VoiceSetupBlock:
	...
	cpdi8	10362, 0
	jr	nz, 92
	.byte 0xd1, 0x66, 0x26, 0x19, 0x5e, 0x26, 0xd1, 0xaf, 0x28, 0x19, 0x5c, 0x26, 0xd1, 0x32, 0x26, 0x19, 0x7f, 0x28, 0xc7, 0xfb, 0x8b
	extz	bc
	ld	wa, bc
	calr	-3153
	cpdi8	10362, 0
	...
	cp	l, 130
	jr	z, 20
	.byte 0xd1, 0x32, 0x26, 0x19, 0xda, 0x26, 0xd1, 0xde, 0x25, 0x19, 0xdc
	.asciz "&@,'"
...
SeqAccomp_SubHandlerA:
	...
	.byte 0xf1, 0x21, 0x04, 0xca
	jrl	nz, 1391
	.byte 0xc7, 0xef, 0x89, 0xc7, 0xef, 0xcf, 0x82
	jr	nz, 19
	ldda8	a, 10417
	bit	0, a
	jrl	nz, 1372
...
NoteEditSy_DisplayUpdateData:
	dec	4, xsp
	.byte 0xd1, 0x6a, 0x27, 0x19, 0xfe, 0x27
	ldda8	a, 10092
	extz	wa
	stda16	10240, wa
	.byte 0xd1, 0x6e, 0x27, 0x19, 0x02, 0x28
	ldda8	a, 10096
	extz	wa
	stda16	10244, wa
	lda	xwa, (xsp+2)
	lda	xbc, (xsp)
	call	15953650
	.byte 0x8f, 0x02, 0x19, 0x22, 0x28, 0x87, 0x19, 0x24, 0x28
	ldda32	xwa, 10610
	ld	xbc, 29884420
	ld	xde, 10
	call	16424455
...
SeqLoad_ProcessDataBlock:
	...
	calr	1234
	ld	(xsp+6), hl
	.byte 0xc7, 0xfb, 0xa9, 0xc7, 0xfb, 0x8b
	extz	bc
	lds	wa, 0
	call	15996901
	ld	iz, hl
	...
	cp	iz, 65535
	jr	z, 45
	.byte 0x9f, 0x06, 0x86, 0xc7, 0xfb, 0x8b
	extz	bc
	lds	wa, 0
	ld	de, iz
	call	15996916
...
SeqBar_DataBlock:
	.byte 0xd1, 0x2f, 0xf2, 0x19, 0xca, 0x29, 0xd1, 0x31, 0xf2, 0x19, 0xcc, 0x29
	ret
	.byte 0xd1, 0xca, 0x29, 0x19, 0x2f, 0xf2, 0xd1, 0xcc, 0x29, 0x19, 0x31, 0xf2
	ret
	lds	hl, 0
	ldda16	wa, 61999
	cps	wa, 0
...
SeqLoad_ReadPartDataBlock:
	...
	add	wa, wa
	ldada	xde, 10702
	.byte 0xd3, 0x07, 0xe8, 0xe0, 0x3f, 0x00, 0x00
	jr	nz, 5
	lds32	xhl, 0
	jrl	198
	ld	xwa, 2048
	ld	(xsp+4), xwa
	.byte 0xbf, 0x0a, 0x02, 0x00, 0x00, 0xbf, 0x08, 0x02, 0x00, 0x00
	ld	c, (xsp+12)
	extz	bc
	cps	bc, 0
	jr	ule, 32
...
SeqPart_ByteBlockA207:
	...
	add	xwa, xde
	ld	a, (xwa)
	.byte 0xc7, 0xfb, 0x99, 0xc7, 0xfb, 0xcf, 0x0d
	jr	z, 6
	.byte 0xc7, 0xfb, 0xcf, 0x10
	jr	nz, 31
	.byte 0xc7, 0xfb, 0xcf, 0x10
	...
	.byte 0xc7, 0xfb, 0xcf, 0x10
	jr	nz, 4
	.byte 0xf1, 0x7b, 0x28, 0xbe, 0xc7, 0xfa, 0x89
	extz	wa
	call	15990615
	cpdi8	10362, 0
	jrl	nz, 145
	.byte 0xc7, 0xfa, 0x61, 0xc7, 0xfa, 0xcf, 0x10
	jr	ule, -68
	call	15991562
	cpdi8	10362, 0
	jr	nz, 125
	...
	jr	nz, 4
	stda8	9782, c
	.byte 0xc7, 0xfa, 0x61, 0xc7, 0xfa, 0x89
	cpda8	a, 10401
	jr	ule, -104
	...
	cpdi8	10362, 0
	ret	nz
	.byte 0xd1, 0x66, 0x26, 0x19, 0x5e, 0x26, 0xd1, 0xaf, 0x28, 0x19, 0x5c, 0x26
	call	15990951
	ldda8	a, 9780
	.byte 0xd1, 0x32, 0x26, 0x19, 0x7f, 0x28
	extz	wa
	...
	cpdi8	10362, 0
	ret	nz
	.byte 0xd1, 0x66, 0x26, 0x19, 0x85, 0x28, 0xd1, 0xaf, 0x28, 0x19, 0x87, 0x28
	ldda16	wa, 9778
	cps	wa, 1
	jr	nz, 87
	.byte 0xd1, 0xde, 0x25, 0x80
	...
	cp	l, 130
	jr	nz, 32
	.byte 0xc1, 0x34, 0x26, 0x19, 0x77, 0x28
	calr	-2263
	ldda8	a, 10359
	dec	1, a
	lds	bc, 1
	...
	cpdi8	10362, 0
	ret	nz
	.byte 0xd1, 0x87, 0x28, 0x19, 0xaf, 0x28, 0xd1, 0x85, 0x28, 0x19, 0x66, 0x26
	call	15990752
	ldda8	a, 10362
	cps	a, 0
	jr	z, 5
	...
	ret	nz
	stdi8	10362, 0
	.byte 0xd1, 0x66, 0x26, 0x19, 0x89, 0x28, 0xd1, 0xaf, 0x28, 0x19, 0x8b, 0x28
	ldada	xwa, 10284
	.byte 0xb0, 0x16, 0x8b, 0x28, 0xb8, 0x02, 0x16, 0x89, 0x28
	ldada	xwa, 10288
	.byte 0xb0, 0x16, 0x87, 0x28, 0xb8, 0x02, 0x16, 0x85, 0x28
	ldada	xwa, 10292
	.byte 0xb0, 0x16, 0x5c, 0x26, 0xb8, 0x02, 0x16, 0x5e, 0x26
	call	15992165
	cpdi8	10362, 0
	ret	nz
	ldada	xde, 10292
...
SeqPart_ByteBlockA95A:
	...
	extz	wa
	lda_24	xde, 14961572
	.byte 0xc3, 0x07, 0xe8, 0xe0, 0x19, 0x7c, 0x28
	ldda8	a, 10359
	dec	1, a
	extz	wa
	extz	xwa
	add	xwa, xbc
	.byte 0x80, 0x19, 0x32, 0x0d
	calr	318
	jrl	283
	ld	e, (xwa)
	cp	e, 13
	...
	cp	e, 16
	jr	nz, 4
	.byte 0xf1, 0x7b, 0x28, 0xbe, 0xc7, 0xfb, 0x89
	extz	wa
	call	15990615
	cpdi8	10362, 0
	jrl	nz, 129
...
SeqPart_ByteBlockAD92:
	...
	cpdi8	10362, 0
	ret	nz
	.byte 0xd1, 0x66, 0x26, 0x19, 0xb2, 0x26, 0xd1, 0xaf, 0x28, 0x19, 0xb0, 0x26
	call	15990752
	ldda8	a, 10362
	cps	a, 0
	jr	z, 13
	...
	cpdi8	10362, 0
	ret	nz
	.byte 0xd1, 0xb8, 0x26, 0x19, 0xac, 0x26
	ldda32	xwa, 9914
	stda16	9902, wa
	ld	c, a
	extz	bc
	...
	.byte 0xb0, 0x16, 0x5c, 0x26, 0xb8, 0x02, 0x16, 0x5e, 0x26
	ldada	xwa, 10288
	.byte 0xb0, 0x16, 0xac, 0x26, 0xb8, 0x02, 0x16, 0xae, 0x26
	ldada	xwa, 10292
	.byte 0xb0, 0x16, 0x87, 0x28, 0xb8, 0x02, 0x16, 0x85, 0x28
	call	15992335
	cpdi8	10362, 0
	...
	ret	nz
	ldada	xwa, 10284
	.byte 0xb0, 0x16, 0xb0, 0x26, 0xb8, 0x02, 0x16, 0xb2, 0x26
	ldada	xwa, 10288
	.byte 0xb0, 0x16, 0x87, 0x28, 0xb8, 0x02, 0x16, 0x85, 0x28
	ldada	xwa, 10292
	.byte 0xb0, 0x16, 0xa8, 0x26, 0xb8, 0x02, 0x16, 0xaa, 0x26
	call	15992165
	cpdi8	10362, 0
	ret	nz
	.byte 0xf1, 0x7b, 0x28, 0xcb
...
SeqPart_ByteBlockB0DE:
	...
	cp	l, 130
	jrl	z, 148
	.byte 0xd1, 0x66, 0x26, 0x19, 0xd2, 0x26, 0xd1, 0xaf, 0x28, 0x19, 0xd4, 0x26
	stdi16	9946, 1
	ldda16	wa, 9778
	dec	1, wa
	stda16	9948, wa
	...
	cp	l, 130
	jr	z, 44
	.byte 0xd1, 0x66, 0x26, 0x19, 0xd6, 0x26, 0xd1, 0xaf, 0x28, 0x19, 0xd8, 0x26
	stdi16	9946, 1
	ldda16	wa, 9862
	dec	1, wa
	stda16	9948, wa
	...
	cpdi8	10362, 0
	jr	nz, 16
	.byte 0xd1, 0x32, 0x26, 0x19, 0xde, 0x26, 0xd1, 0x86, 0x26, 0x19, 0xe0, 0x26
	call	15995104
	jp	16005702
...
SeqPart_VelCurveData:
	...
	extz	de
	lda_24	xbc, 14962294
	.byte 0xc3, 0x07, 0xe4, 0xe8, 0x19, 0x40, 0x26
	ld	xbc, 14962332
	.byte 0xc3, 0x07, 0xe4, 0xe8, 0x19, 0x42, 0x26
	jrl	449
	ld	a, c
	cp	c, 12
	jr	nc, 4
