...
AccStyle_TempoMultiplierTable:
	...
	ld	(xix), 200
	nop
	.byte 0xdc, 0x00, 0xf0, 0x00, 0x04, 0x01, 0x18, 0x01
	jr	1
...
AccStyle_ByteDataBlock:
	ld	xhl, 16082506
	.byte 0xc9, 0xec, 0x01, 0xd3, 0x03, 0xec, 0xe0, 0x23
	extz	xhl
	add	xhl, xiy
	cpdi8	13268, 1
	jr	nz, 5
...
AccTuning_ValueTable:
	...
	ldwio	15, 3855
	retd	0x140f
	.byte 0x14, 0x14, 0x14, 0x14, 0x19, 0x19, 0x19, 0x19, 0x19, 0x1e, 0x1e
	calr	0x1e1e
	.ascii "#####"
...
AccVoice_CopyFromROM_DataBlock:
	...
	nop
	ei	0x06
	.byte 0x01, 0x0b, 0x03, 0x00, 0x0b, 0x04, 0x00
	decf
	.byte 0x02
	nop
	decf
...
RhythmROM_PatternDisp_InitLoop:
	neg	wa
	.byte 0xd3, 0x03, 0xd3, 0x07, 0xd3, 0x03, 0xd3, 0x07, 0xd2, 0x03, 0xd2, 0x03
	ld	wa, 984
...
DrumKit_GroupAssignTable:
	...
	nop
	nop
	.byte 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02
	nop
	nop
	nop
	nop
...
DrumKit_FallbackSlotTable:
	...
	ccf
	zcf
	.byte 0x14, 0x15, 0x16, 0x17, 0x08, 0x09, 0x0a, 0x0b, 0x18, 0x19, 0x1a, 0x1b, 0x1d, 0x1d
...
RhythmPatInit_KitIndexTable:
	...
	ld	xix, 16142024
	and	hl, 3
	.byte 0xdb, 0xee, 0x02, 0xe3, 0x07, 0xf0, 0xec, 0x23, 0xb3, 0xe8
	ret
	muls	xiz, xbc
	.byte 0xf6
	nop
...
AccVoice_SetupSlots_DataBlock:
	...
	calr	-116
	calr	-1013
	.byte 0xd9, 0xee, 0x01, 0xd3, 0x07, 0xf0, 0xe4, 0x23
	stda16	13842, hl
	stdi16	13844, 6
	ret
	ldb	c, 0
...
AccScreen_DataBlock:
	...
	ld	xbc, xhl
	and	l, 31
	.byte 0xcf, 0xec, 0x02, 0xe3, 0x03, 0xf0, 0xec, 0x24, 0xb4, 0xe8
	ret
	push	xix
	cp	e, 32
	jr	ule, 2
...
; Accompaniment step recording UI data: 698 bytes
	...
	.byte 0xf0, 0x05, 0x22
	nop
	.byte 0x88, 0x00, 0x04, 0x0b, 0xb9, 0x39, 0x03
	nop
	ret
	jrl	ule, -2388
	nop
	...
	.byte 0x01
	retd	0x0021
	.byte 0x09, 0x00, 0xb1, 0x13
	ldb	a, 0
	.byte 0x09, 0x00
	jr	lt, 24
	ldb	a, 0
	.byte 0x09, 0x00, 0xb9, 0x1a, 0x1f
	nop
	.byte 0x16
	nop
...
; Accompaniment variation/section data: 120 bytes
	...
	ldb	w, 65
	ld	xiz, 542262612
	.byte 0x54, 0x4f, 0x55, 0x43, 0x48, 0x3d
...
; Accompaniment part names and ordering: 955 bytes
	...
	ldwio	137, 42496
	nop
	.byte 0xc8, 0x00, 0xa6, 0x00, 0x02
	ldwio	200, 40704
	nop
	.byte 0xc8, 0x00, 0xa6, 0x00, 0x01
	ldwio	201, 42496
	nop
	.byte 0x09, 0x01, 0xa6, 0x00, 0x02
	ldwio	9, 40705
	nop
	.byte 0x09, 0x01, 0xa6, 0x00, 0x09, 0x00
	scf
	nop
	.byte 0x19
	nop
	...
	ccf
	zcf
	.byte 0x14, 0x15, 0x16, 0x17, 0x08, 0x09, 0x0a, 0x0b, 0x18, 0x19, 0x1a, 0x1b, 0x1c
	call	3981627
	ldw	iy, 23329
	ret
...
AccStyle_TableDataEntry:
	...
	.byte 0xc7, 0xfa, 0x99
	ld	a, (xbc+2)
	.byte 0xc7, 0xfb, 0x99, 0xc7, 0xf9, 0xcf, 0x48
	jr	nz, 11
	.byte 0xc7, 0xfa, 0xd8
	jr	nz, 6
	...
	stda32	14770, xwa
	stdi8	14672, 0
	.byte 0xf1, 0xb0, 0x35, 0xb0, 0xc7, 0xfb, 0xa8
	ld	e, (xsp+4)
	sub	e, 30
	extz	de
	.byte 0xc7, 0xfb, 0x89
