...
AccVoice_BarCounterBytecodeData:
	...
	call	16115456
	ld	xiz, xhl
	.byte 0xc1, 0x0a, 0x33, 0x21, 0xc9, 0xd9, 0x66, 0x13
	.byte 0xc9, 0xdc, 0x66, 0x0a
	cp	a, 8
	.byte 0x6e, 0x0a
	ldw	bc, 1056
	.byte 0x68, 0x08
...
AccTuning_ComplexBytecodeData:
	...
	.byte 0x21, 0xc9, 0xda, 0x6e, 0x35, 0xf1, 0xd6, 0x33
	.byte 0x02, 0xfe, 0xff, 0x68, 0x5a
	and	c, 64
	cp	c, 64
	.byte 0x66, 0x09
	and	e, 1
...
RhythmPatInit_KitIndexTable:
	...
	and	hl, 3
	sll	hl, 2
	.byte 0xe3, 0x07, 0xf0, 0xec, 0x23, 0xb3, 0xe8
	ret
	muls	xiz, xbc
	.byte 0xf6
	nop
...
AccVoice_SetupSlots_DataBlock:
	...
	.byte 0x1e, 0xa8, 0x00
	pop l
	.byte 0xc8, 0xd8, 0x66, 0x0d, 0x1e, 0xe0, 0x00, 0xf1
	.byte 0xc9, 0x37, 0x47, 0x1e, 0x9b, 0xfd, 0x78, 0xca
	.byte 0xff
	ldb	a, 1
	.byte 0xf1, 0xc9, 0x37, 0x41
	lds32	xbc, 0
	...
	add	xbc, 14258
	ld	a, (xbc)
	.byte 0xc9, 0xd8, 0x66, 0x21, 0x1e, 0x13, 0x01, 0x1e
	.byte 0x7b, 0xf5
	sll	xbc, 2
	add	xbc, 14488
	ld	xwa, (xbc)
	...
	ldb	a, 0
	ld	xix, 13357
	.byte 0xcf, 0xda, 0x6a, 0x2e, 0xc9, 0xda, 0x6a, 0x2a
	.byte 0xc3, 0x03, 0xf0, 0xec, 0x26
	bit	7, h
	.byte 0x66, 0x04
	inc	1, l
	...
	.byte 0x68, 0x04
	inc	1, l
	.byte 0x68, 0x00, 0x68, 0xce, 0xcf, 0xda, 0x62, 0x02
	ldb	l, 0
	ret
	.byte 0x1e, 0x68, 0xf4
	ld	ix, bc
...
CmpNcpTtl_Dispatch2:
	...
	ldw	wa, 134
	call	16356697
	.byte 0xc1, 0xa8, 0x39, 0x21, 0xc9, 0xd9, 0x66, 0x34
	.byte 0xc9, 0xd8, 0x7e, 0x11, 0x01
	ld	xwa, 12058650
	ld	xbc, 29360140
	lds32	xde, 0
	call	16424455
...
AccPatch_VoiceAssignDataBlock:
	...
	nop
	dec	1, c
	.byte 0xcb, 0xd8, 0x6b, 0xe3, 0x68, 0x0c
	add	xiy, 256
	dec	1, c
	.byte 0xcb, 0xd8, 0x6b, 0xd0
	inc	1, wa
