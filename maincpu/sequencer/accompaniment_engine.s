...
AccPlayMode_Dispatch_Table:
	...
	tsetm	7, (xde)
	.byte 0xf5, 0x00, 0x9d, 0xaf, 0xf5, 0x00
	ret
	nop
	nop
...
AccTone_InlineBytecodeData:
	...
	setda	0, 13343
	setda	0, 13342
	.byte 0xc1, 0x2a, 0x34, 0x19, 0x21, 0x34, 0xc1, 0x2b
	.byte 0x34, 0x19, 0x20, 0x34
	ret
	ldda8	a, 13016
	extz	wa
	lda_24	xbc, 14983112
	...
	setda	7, 13100
	calr	23
	.byte 0xc1, 0xd8, 0x32, 0x19, 0xdf, 0x32, 0xc1, 0xd9
	.byte 0x32, 0x19, 0xe0, 0x32, 0xc1, 0xda, 0x32, 0x19
	.byte 0xe1, 0x32
	resda	0, 13343
	ret
	calr	1327
...
AccVoice_SetupSlots_DataBlock:
	...
	ldb	a, 4
	stda8	14281, a
	.byte 0x1e, 0x69, 0x00, 0x1e, 0x49, 0x01
	push l
	.byte 0x1e, 0xa8, 0x00
	pop l
	cps	w, 0
...
AccPatch_VoiceAssignDataBlock:
	...
	ret
	stdi8	14672, 0
	.byte 0xf1, 0x70, 0x39, 0x02, 0x00, 0x00, 0xf1, 0x72
