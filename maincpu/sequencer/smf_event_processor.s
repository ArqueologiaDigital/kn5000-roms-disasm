...
SeqStep_FileSectorPopReturn:
	...
	ld	xwa, (xsp+20)
	push xwa
	.byte 0x1e, 0x0c, 0xf9, 0xbf, 0x0e, 0x37
	ld	xbc, xhl
	ld	xwa, (xsp+10)
	ld	(xwa+38), xbc
	or	xhl, xhl
	...
	add	xwa, xhl
	ld	(xwa), c
	.byte 0x9f, 0x04, 0x3f, 0xff, 0x01, 0x6e, 0x29
	pushw 6
	lds32	xwa, 0
	push xwa
	ld	xwa, xiz
	...
	ldb	w, 0
	ld	(xbc), a
	.byte 0x9f, 0x04, 0x3f, 0xff, 0x01, 0x6e, 0x39
	pushw 6
	lds32	xwa, 0
	push xwa
	ld	xwa, xiz
	...
	ld	xwa, (xsp+20)
	push xwa
	.byte 0x1e, 0xb8, 0xf7, 0xbf, 0x0e, 0x37
	ld	xbc, xhl
	ld	xwa, (xsp+10)
	ld	(xwa+38), xbc
	or	xhl, xhl
	...
	ld	wa, (xiz+42)
	ld	(xsp+4), wa
	.byte 0x9f, 0x04, 0x3f, 0x00, 0x00, 0x6e, 0x09, 0xbe
	.byte 0x2c, 0x02, 0x00, 0x00
	lds	hl, 0
	.byte 0x68, 0x27, 0xbe, 0x2c, 0x02, 0x01, 0x00, 0x68
	.byte 0x0d, 0x9f, 0x04, 0x61
	ld	wa, (xsp+4)
	cp	wa, hl
	...
	inc	0, xsp
	ld	xwa, (xsp+20)
	.byte 0x98, 0x45, 0x3f, 0x00, 0x00, 0x6e, 0x08
	ld	xwa, (xsp+20)
	ld	(xwa+69), iz
	.byte 0x68, 0x1a
	pushw iz
	...
	.byte 0x1e, 0x0c, 0xfd
	inc	0, xsp
	.byte 0x9f, 0x08, 0x3f, 0x00, 0x00, 0x6e, 0x06
	ld	xwa, (xsp+20)
	.byte 0x98, 0x2e, 0x61
	ld	(xsp+6), iz
	.byte 0x9f, 0x0a, 0x61
	...
	.byte 0x6e, 0x08
	ld	xwa, (xsp+20)
	.byte 0x98, 0x2c, 0x61, 0x68, 0x05, 0xbf, 0x0a, 0x02
	.byte 0x00, 0x00, 0x9f, 0x08, 0x3f, 0x00, 0x00, 0x6e
	.byte 0x14
	ld	xwa, (xsp+20)
	ld	(xwa+42), iz
	ld	(xsp+8), iz
	...
	.byte 0x6e, 0x05
	ldw	hl, 10
	.byte 0x68, 0x2d, 0x9b, 0x14, 0x3f, 0x00, 0x00, 0x66
	.byte 0x05
	ld	hl, (xhl+20)
	.byte 0x68, 0x21
	pushw 512
...
SeqByteBlock_StyleBitmapRef:
	...
	push xwa
	push xiz
	.byte 0x1e, 0x7b, 0xee, 0xbf, 0x12, 0x37
	ld	(xsp+4), xhl
	ld	xwa, (xsp+4)
	or	xwa, xwa
	.byte 0x6e, 0x05
	...
	ld	xwa, (xsp+18)
	push xwa
	.byte 0x1e, 0xc6, 0xf4, 0xbf, 0x0e, 0x37
	ld	iz, qiz
	cps	iz, 0
	.byte 0x66, 0x0f
	ld	xwa, (xsp+8)
	...
	.byte 0x63, 0xd1
	ld	xwa, (xsp+8)
	.byte 0xb8, 0x03, 0xcd, 0x6e, 0x18
	ld	xwa, (xsp+8)
	.byte 0xb8, 0x45, 0x02, 0x00, 0x00
	lds	bc, 0
	ld	xwa, (xsp+8)
	ld	(xwa+42), bc
	ld	xwa, (xsp+8)
	...
	.byte 0xbf, 0xde, 0x37
	push xiz
	.byte 0xbf, 0x12, 0x02, 0x00, 0x00, 0xbf, 0x14, 0x02
	.byte 0x00, 0x00, 0xbf, 0x16, 0x02, 0x01, 0x00
	lds32	xwa, 0
	ld	(xsp+24), xwa
	lds32	xhl, 0
	.byte 0xbf, 0x20, 0x02, 0xff, 0x0f
	ld	xwa, (xsp+42)
	ld	xwa, (xwa+26)
	ld	(xsp+4), xwa
	ld	xwa, (xsp+42)
	...
	ld	(xwa+12), xbc
	ld	xwa, (xsp+4)
	.byte 0xb8, 0x32, 0x02, 0x20, 0x00
	ld	xwa, (xsp+4)
	.byte 0xb8, 0x34, 0x02, 0x08, 0x00
	ld	xwa, (xsp+42)
	.byte 0xb8, 0x04, 0xcf, 0x76, 0x1f, 0x01, 0xbf, 0x10
	.byte 0x02, 0x00, 0x00, 0x78, 0xfb, 0x00
	ld	xwa, (xsp+8)
	push xwa
	ld	xwa, (xsp+28)
	push xwa
