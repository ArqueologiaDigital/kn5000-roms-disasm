...
if os.path.exists(elf_for_addrs):
    ...
    v7_code_blocks = [
        ...
        ('v7_fix_emptyroutine_03.bin', 'EmptyRoutine_03', 1),
        ('v7_fix_extdata_normscreenproc_ptr.bin', 'ExtData_NormScreenProc_Ptr', 4),
        ('v7_fix_numtoascii_onesdigitandfinish.bin', 'NumToAscii_OnesDigitAndFinish', 28),
        ('v7_fix_voice_initbanktables_slotloop.bin', 'Voice_InitBankTables_SlotLoop', 21),
        ('v7_fix_free_x.bin', 'free_X', 8),
        ('v7_fix_boot_readfdcstatus.bin', 'Boot_ReadFDCStatus', 5),
        ('v7_fix_colorblit2_largecodeblock.bin', 'ColorBlit2_LargeCodeBlock', 4128),
        ('v7_fix_rvari_select_checksamebank.bin', 'RVari_Select_CheckSameBank', 931),
        ('v7_fix_math_absint16.bin', 'Math_AbsInt16', 10),
        ('v7_fix_accstyle_tabledataentry.bin', 'AccStyle_TableDataEntry', 1116),
        ('v7_fix_midicc_resetstate.bin', 'MidiCC_ResetState', 11),
        ('v7_fix_dspcfg_returnvaluetable.bin', 'DSPCfg_ReturnValueTable', 21),
        ('v7_fix_voiceparam_lookupandenqueue.bin', 'VoiceParam_LookupAndEnqueue', 60),
        ('v7_fix_tuningsystem_handler_table.bin', 'TuningSystem_Handler_Table', 9312),
        ('v7_fix_semenu_refreshpartdisplay_data.bin', 'SeMenu_RefreshPartDisplay_Data', 1613),
        ('v7_fix_accstate_readaccompparams.bin', 'AccState_ReadAccompParams', 36),
        ('v7_fix_effectparam_edit_table.bin', 'EffectParam_Edit_Table', 188),
        ('v7_fix_drumdetailedit_menu_table.bin', 'DrumDetailEdit_Menu_Table', 1024),
