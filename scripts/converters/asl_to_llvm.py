...
# Semantic instruction map for extended addressing mode patterns.
# Key: (category, size_char, sub_opc, nops) → (asm_mnemonic, addr_len)
# Generated by scripts/gen_semantic_instrs.py — do not edit manually.
SEMANTIC_MAP = {
    ('dd16', None, 0x04, 3): ('x_dd163_s04', 2),
    ('dd16', None, 0x06, 3): ('x_dd163_s06', 2),
    ('dd16', None, 0x2C, 3): ('x_dd163_s2c', 2),
    ('dd16', None, 0x9C, 3): ('x_dd163_s9c', 2),
    ('dd16', None, 0x9F, 3): ('x_dd163_s9f', 2),
    ('dd16', None, 0xA8, 3): ('x_dd163_sa8', 2),
    ('dd16', None, 0xA9, 3): ('x_dd163_sa9', 2),
    ('dd16', None, 0xAA, 3): ('x_dd163_saa', 2),
    ('dd16', None, 0xAB, 3): ('x_dd163_sab', 2),
    ('dd16', None, 0xAC, 3): ('x_dd163_sac', 2),
    ('dd16', None, 0xAD, 3): ('x_dd163_sad', 2),
    ('dd16', None, 0xAE, 3): ('x_dd163_sae', 2),
    ('dd16', None, 0xAF, 3): ('x_dd163_saf', 2),
    ('dd24', None, 0x14, 6): ('x_dd246_o14_t2', 3),
    ('dd24', None, 0x16, 6): ('x_dd246_o16_t2', 3),
    ('dd8', None, 0x31, 2): ('x_dd82_s31', 1),
    ('dd8', None, 0x33, 2): ('x_dd82_s33', 1),
    ('dd8', None, 0x41, 2): ('x_dd82_s41', 1),
    ('dd8', None, 0x9C, 2): ('x_dd82_s9c', 1),
    ('dd8', None, 0x9E, 2): ('x_dd82_s9e', 1),
    ('dd8', None, 0xB0, 2): ('x_dd82_sb0', 1),
    ('dd8', None, 0xB1, 2): ('x_dd82_sb1', 1),
    ('dd8', None, 0xB2, 2): ('x_dd82_sb2', 1),
    ('dd8', None, 0xB3, 2): ('x_dd82_sb3', 1),
    ('dd8', None, 0xB8, 2): ('x_dd82_sb8', 1),
    ('dd8', None, 0xB9, 2): ('x_dd82_sb9', 1),
    ('dd8', None, 0xBA, 2): ('x_dd82_sba', 1),
    ('dd8', None, 0xBB, 2): ('x_dd82_sbb', 1),
    ('dd8', None, 0xC8, 2): ('x_dd82_sc8', 1),
    ('dd8', None, 0xC9, 2): ('x_dd82_sc9', 1),
    ('dd8', None, 0xCA, 2): ('x_dd82_sca', 1),
    ('dd8', None, 0xCB, 2): ('x_dd82_scb', 1),
    ('dd8', None, 0xCD, 2): ('x_dd82_scd', 1),
    ('dd8', None, 0xCE, 2): ('x_dd82_sce', 1),
    ('dpd', None, 0x00, 3): ('x_dpd3_o00_t1', 1),
    ('dpi', None, 0x00, 3): ('x_dpi3_o00_t1', 1),
    ('dpi', None, 0x02, 4): ('x_dpi4_o02_t2', 1),
    ('dpi', None, 0x31, 2): ('x_dpi2_s31', 1),
    ('dpi', None, 0x32, 2): ('x_dpi2_s32', 1),
    ('dpi', None, 0x33, 2): ('x_dpi2_s33', 1),
    ('dpi', None, 0x34, 2): ('x_dpi2_s34', 1),
    ('dpi', None, 0x35, 2): ('x_dpi2_s35', 1),
    ('dpi', None, 0x40, 2): ('x_dpi2_s40', 1),
    ('dpi', None, 0x41, 2): ('x_dpi2_s41', 1),
    ('dpi', None, 0x42, 2): ('x_dpi2_s42', 1),
    ('dpi', None, 0x43, 2): ('x_dpi2_s43', 1),
    ('dpi', None, 0x45, 2): ('x_dpi2_s45', 1),
    ('dpi', None, 0x47, 2): ('x_dpi2_s47', 1),
    ('dpi', None, 0x50, 2): ('x_dpi2_s50', 1),
    ('dpi', None, 0x51, 2): ('x_dpi2_s51', 1),
    ('dpi', None, 0x52, 2): ('x_dpi2_s52', 1),
    ('dpi', None, 0x54, 2): ('x_dpi2_s54', 1),
    ('dpi', None, 0x55, 2): ('x_dpi2_s55', 1),
    ('dpi', None, 0x60, 2): ('x_dpi2_s60', 1),
    ('dpi', None, 0x61, 2): ('x_dpi2_s61', 1),
    ('dpi', None, 0x63, 2): ('x_dpi2_s63', 1),
    ('dpi', None, 0x64, 2): ('x_dpi2_s64', 1),
    ('dri', None, 0x00, 5): ('x_dri5_o00_t1', 3),
    ('dri', None, 0x02, 6): ('x_dri6_o02_t2', 3),
    ('dri', None, 0x14, 6): ('x_dri6_o14_t2', 3),
    ('dri', None, 0x16, 6): ('x_dri6_o16_t2', 3),
    ('dri', None, 0x98, 4): ('x_dri4_s98', 3),
    ('dri', None, 0x9A, 4): ('x_dri4_s9a', 3),
    ('dri', None, 0x9F, 4): ('x_dri4_s9f', 3),
    ('dri', None, 0xB4, 4): ('x_dri4_sb4', 3),
    ('dri', None, 0xB7, 4): ('x_dri4_sb7', 3),
    ('dri', None, 0xBD, 4): ('x_dri4_sbd', 3),
    ('dri', None, 0xBE, 4): ('x_dri4_sbe', 3),
    ('dri', None, 0xC8, 4): ('x_dri4_sc8', 3),
    ('dri', None, 0xC9, 4): ('x_dri4_sc9', 3),
    ('dri', None, 0xCA, 4): ('x_dri4_sca', 3),
    ('dri', None, 0xCB, 4): ('x_dri4_scb', 3),
    ('dri', None, 0xCC, 4): ('x_dri4_scc', 3),
    ('dri', None, 0xCD, 4): ('x_dri4_scd', 3),
    ('dri', None, 0xCE, 4): ('x_dri4_sce', 3),
    ('dri', None, 0xCF, 4): ('x_dri4_scf', 3),
    ('dri', None, 0xD8, 4): ('x_dri4_sd8', 3),
    ('erp', 'b', 0x03, 3): ('x_erpb3_o03_t1', 1),
    ('erp', 'b', 0x09, 3): ('x_erpb3_o09_t1', 1),
    ('erp', 'b', 0x30, 3): ('x_erpb3_o30_t1', 1),
    ('erp', 'b', 0x31, 3): ('x_erpb3_o31_t1', 1),
    ('erp', 'b', 0x33, 3): ('x_erpb3_o33_t1', 1),
    ('erp', 'b', 0xC8, 3): ('x_erpb3_oc8_t1', 1),
    ('erp', 'b', 0xCA, 3): ('x_erpb3_oca_t1', 1),
    ('erp', 'b', 0xCC, 3): ('x_erpb3_occ_t1', 1),
    ('erp', 'b', 0xCE, 3): ('x_erpb3_oce_t1', 1),
    ('erp', 'b', 0xCF, 3): ('x_erpb3_ocf_t1', 1),
    ('erp', 'b', 0xEF, 3): ('x_erpb3_oef_t1', 1),
    ('erp', 'l', 0xC8, 6): ('x_erpl6_oc8_t4', 1),
    ('erp', 'w', 0x03, 4): ('x_erpw4_o03_t2', 1),
    ('erp', 'w', 0x33, 3): ('x_erpw3_o33_t1', 1),
    ('erp', 'w', 0xC8, 4): ('x_erpw4_oc8_t2', 1),
    ('erp', 'w', 0xCE, 4): ('x_erpw4_oce_t2', 1),
    ('erp', 'w', 0xCF, 4): ('x_erpw4_ocf_t2', 1),
    ('erp', 'w', 0xEF, 3): ('x_erpw3_oef_t1', 1),
    ('sd16', 'b', 0x04, 3): ('x_sd16b3_s04', 2),
    ('sd16', 'b', 0x30, 3): ('x_sd16b3_s30', 2),
    ('sd16', 'b', 0x41, 3): ('x_sd16b3_s41', 2),
    ('sd16', 'b', 0x43, 3): ('x_sd16b3_s43', 2),
    ('sd16', 'b', 0x7C, 3): ('x_sd16b3_s7c', 2),
    ('sd16', 'w', 0x04, 3): ('x_sd16w3_s04', 2),
    ('sd16', 'w', 0x48, 3): ('x_sd16w3_s48', 2),
    ('sd24', 'b', 0x19, 6): ('x_sd24b6_o19_t2', 3),
    ('sd24', 'w', 0x04, 4): ('x_sd24w4_s04', 3),
    ('sd24', 'w', 0x19, 6): ('x_sd24w6_o19_t2', 3),
    ('sd8', 'b', 0x21, 2): ('x_sd8b2_s21', 1),
    ('sd8', 'b', 0x23, 2): ('x_sd8b2_s23', 1),
    ('sd8', 'b', 0x3C, 3): ('x_sd8b3_o3c_t1', 1),
    ('sd8', 'b', 0x3E, 3): ('x_sd8b3_o3e_t1', 1),
    ('spi', 'b', 0x3F, 3): ('x_spib3_o3f_t1', 1),
    ('sri', 'b', 0x19, 6): ('x_srib6_o19_t2', 3),
    ('sri', 'b', 0x3A, 5): ('x_srib5_o3a_t1', 3),
    ('sri', 'b', 0x3C, 5): ('x_srib5_o3c_t1', 3),
    ('sri', 'b', 0x3E, 5): ('x_srib5_o3e_t1', 3),
    ('sri', 'b', 0x3F, 5): ('x_srib5_o3f_t1', 3),
    ('sri', 'b', 0x61, 4): ('x_srib4_s61', 3),
    ('sri', 'b', 0x69, 4): ('x_srib4_s69', 3),
    ('sri', 'b', 0x88, 4): ('x_srib4_s88', 3),
    ('sri', 'b', 0x89, 4): ('x_srib4_s89', 3),
    ('sri', 'b', 0xA9, 4): ('x_srib4_sa9', 3),
    ('sri', 'b', 0xC1, 4): ('x_srib4_sc1', 3),
    ('sri', 'b', 0xC9, 4): ('x_srib4_sc9', 3),
    ('sri', 'b', 0xD1, 4): ('x_srib4_sd1', 3),
    ('sri', 'b', 0xE1, 4): ('x_srib4_se1', 3),
    ('sri', 'b', 0xE3, 4): ('x_srib4_se3', 3),
    ('sri', 'b', 0xE9, 4): ('x_srib4_se9', 3),
    ('sri', 'b', 0xEB, 4): ('x_srib4_seb', 3),
    ('sri', 'b', 0xF1, 4): ('x_srib4_sf1', 3),
    ('sri', 'b', 0xF3, 4): ('x_srib4_sf3', 3),
    ('sri', 'b', 0xF5, 4): ('x_srib4_sf5', 3),
    ('sri', 'b', 0xF8, 4): ('x_srib4_sf8', 3),
    ('sri', 'b', 0xF9, 4): ('x_srib4_sf9', 3),
    ('sri', 'b', 0xFB, 4): ('x_srib4_sfb', 3),
    ('sri', 'b', 0xFD, 4): ('x_srib4_sfd', 3),
    ('sri', 'b', 0xFF, 4): ('x_srib4_sff', 3),
    ('sri', 'l', 0x80, 4): ('x_sril4_s80', 3),
    ('sri', 'l', 0x82, 4): ('x_sril4_s82', 3),
    ('sri', 'l', 0x83, 4): ('x_sril4_s83', 3),
    ('sri', 'l', 0x84, 4): ('x_sril4_s84', 3),
    ('sri', 'l', 0x85, 4): ('x_sril4_s85', 3),
    ('sri', 'l', 0x86, 4): ('x_sril4_s86', 3),
    ('sri', 'l', 0x88, 4): ('x_sril4_s88', 3),
    ('sri', 'l', 0xAB, 4): ('x_sril4_sab', 3),
    ('sri', 'l', 0xF0, 4): ('x_sril4_sf0', 3),
    ('sri', 'l', 0xF1, 4): ('x_sril4_sf1', 3),
    ('sri', 'l', 0xF3, 4): ('x_sril4_sf3', 3),
    ('sri', 'l', 0xF8, 4): ('x_sril4_sf8', 3),
    ('sri', 'l', 0xFE, 4): ('x_sril4_sfe', 3),
    ('sri', 'w', 0x04, 4): ('x_sriw4_s04', 3),
    ('sri', 'w', 0x19, 6): ('x_sriw6_o19_t2', 3),
    ('sri', 'w', 0x30, 4): ('x_sriw4_s30', 3),
    ('sri', 'w', 0x3F, 6): ('x_sriw6_o3f_t2', 3),
    ('sri', 'w', 0x61, 4): ('x_sriw4_s61', 3),
    ('sri', 'w', 0x68, 4): ('x_sriw4_s68', 3),
    ('sri', 'w', 0x6A, 4): ('x_sriw4_s6a', 3),
    ('sri', 'w', 0x81, 4): ('x_sriw4_s81', 3),
    ('sri', 'w', 0x84, 4): ('x_sriw4_s84', 3),
    ('sri', 'w', 0x88, 4): ('x_sriw4_s88', 3),
    ('sri', 'w', 0xA0, 4): ('x_sriw4_sa0', 3),
    ('sri', 'w', 0xC0, 4): ('x_sriw4_sc0', 3),
    ('sri', 'w', 0xC2, 4): ('x_sriw4_sc2', 3),
    ('sri', 'w', 0xE0, 4): ('x_sriw4_se0', 3),
    ('sri', 'w', 0xE2, 4): ('x_sriw4_se2', 3),
    ('sri', 'w', 0xF0, 4): ('x_sriw4_sf0', 3),
    ('sri', 'w', 0xF2, 4): ('x_sriw4_sf2', 3),
    ('sri', 'w', 0xF6, 4): ('x_sriw4_sf6', 3),
    ('sri', 'w', 0xFB, 4): ('x_sriw4_sfb', 3),
    # --- Additional patterns found in subcpu ROMs ---
...
# Helper to compute addr_len for SEMANTIC_MAP sub-opcode extraction.
def _get_addr_len(cat, operand_bytes):
    """Return the number of addressing bytes before the sub-opcode."""
    if cat in ('erp', 'spi', 'spd', 'dpi', 'dpd', 'sd8', 'dd8'):
        return 1
    elif cat in ('sd16', 'dd16'):
        return 2
    elif cat in ('sd24', 'dd24'):
        return 3
    elif cat in ('sri', 'dri'):
        if len(operand_bytes) < 1:
            return 0
        mode_type = operand_bytes[0] & 0x03
        if mode_type == 0:
            return 1
    ...
    if rom_bytes is not None and 2 <= nbytes <= 10:
        ...
        if first >= 0x80:
            ...
            if hi_nibble in (0xC, 0xD, 0xE) and low_nibble <= 7:
                ...
                # Try SEMANTIC_MAP for remaining source category patterns
                SRC_CAT_MAP = {
                    0: 'sd8', 1: 'sd16', 2: 'sd24', 3: 'sri',
                    4: 'spd', 5: 'spi', 7: 'erp',
                }
                cat = SRC_CAT_MAP.get(low_nibble)
                if cat and nop >= 2:
                    addr_len = _get_addr_len(cat, operand_bytes)
                    if addr_len > 0 and nop > addr_len:
                        sub_opc = operand_bytes[addr_len]
                        key = (cat, size_char, sub_opc, nop)
                        sem = SEMANTIC_MAP.get(key)
                        if sem:
                            mnem, _ = sem
                            remaining = list(operand_bytes[:addr_len]) + list(operand_bytes[addr_len+1:])
                            byte_args = ', '.join(f'0x{b:02X}' for b in remaining)
                            return f"{mnem} {byte_args}", nbytes
                # Fallback: emit as extpfx (prefix + literal operand bytes)
                if cat and 1 <= nop <= 8:
            ...
            if hi_nibble == 0xF and low_nibble <= 5:
                ...
                # Try SEMANTIC_MAP for remaining dest category patterns
                DST_CAT_MAP = {
                    0: 'dd8', 1: 'dd16', 2: 'dd24',
                    3: 'dri', 4: 'dpd', 5: 'dpi',
                }
                cat = DST_CAT_MAP.get(low_nibble)
                if cat and nop >= 2:
                    addr_len = _get_addr_len(cat, operand_bytes)
                    if addr_len > 0 and nop > addr_len:
                        sub_opc = operand_bytes[addr_len]
                        key = (cat, None, sub_opc, nop)
                        sem = SEMANTIC_MAP.get(key)
                        if sem:
                            mnem, _ = sem
                            remaining = list(operand_bytes[:addr_len]) + list(operand_bytes[addr_len+1:])
