...
VoiceParam_FullSetup_ExtData:
	...
	muls	wa, 287
	lda_24	xbc, 267118
	.byte 0xe3, 0x07, 0xe4, 0xe0, 0x20, 0xb8, 0x5d, 0xcf
	.byte 0x66, 0x16
	ld	a, (xsp)
	extz	wa
	muls	wa, 287
...
VoiceAlloc_WithRoutingFlag_ExtData:
	...
	.byte 0xd3, 0x07, 0xf0, 0xe0, 0x20
	lda_24	xix, 195066
	.byte 0xf3, 0x07, 0xf0, 0xe0, 0xd8, 0x78, 0x82, 0x03
	ld	xwa, (xsp+2)
	ld	a, (xwa+1)
	extz	wa
	call	207646
	...
	muls	wa, 287
	lda_24	xbc, 267214
	.byte 0xf3, 0x07, 0xe4, 0xe0, 0x47, 0x78, 0xc0, 0x00
	ld	xwa, (xsp+2)
	ld	a, (xwa+1)
	extz	wa
	call	207646
...
VoiceParamFinalize_SecondaryBody:
	...
	muls	wa, 287
	lda_24	xbc, 267222
	.byte 0xe3, 0x07, 0xe4, 0xe0, 0x21, 0x68, 0x13
	ld	a, (xiz+1)
	extz	wa
	muls	wa, 287
	lda_24	xbc, 267259
	...
	muls	wa, 287
	lda_24	xbc, 267226
	.byte 0xe3, 0x07, 0xe4, 0xe0, 0x21, 0x68, 0x3d
	ld	a, (xiz+1)
	extz	wa
	muls	wa, 287
	lda_24	xbc, 267263
	.byte 0xe3, 0x07, 0xe4, 0xe0, 0x21, 0x68, 0x28
	ld	a, (xiz+1)
	extz	wa
	muls	wa, 287
	lda_24	xbc, 267300
