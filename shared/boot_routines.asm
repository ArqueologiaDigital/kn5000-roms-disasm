...
Detect_Region_Code:
	...
	BIT	1, (PH)
	JR	Z, .mode2
	LD	(REGION_CODE_VAR), 001h		; Region 1
	RET
.mode2:
	LD	(REGION_CODE_VAR), 002h		; Region 2
	RET
.check_bit1_only:
	BIT	1, (PH)
	JR	Z, .mode4
	LD	(REGION_CODE_VAR), 003h		; Region 3
	RET
.mode4:
	LD	(REGION_CODE_VAR), 004h		; Region 4
	RET
