...
AccStyle_DetectChanges_ClearFlags:
	.byte 0xf1, 0xb8, 0x32, 0x00, 0x00	; stdi8 (0x3354), 0 (v7 patched)

	.byte 0xf1, 0xb9, 0x32, 0x00, 0x00	; stdi8 (0x3355), 0 (v7 patched)

	.byte 0xf1, 0xc3, 0x32, 0x00, 0x00	; stdi8 (0x335f), 0 (v7 patched)

	.byte 0xc1, 0xbb, 0x32, 0x3c, 0xfc	; anddi8 (0x3357), 252 (v7 patched)

	.byte 0xc1, 0xc5, 0x32, 0x3c, 0x78	; anddi8 (0x3361), 120 (v7 patched)
...
AccPedal_DirA_Apply:
	.byte 0xc1, 0x39, 0x33, 0x21	; ldb_d8 a, (0x33d5) (v7 patched)

	.byte 0x1d, 0xb6, 0x62, 0xf5	; call AccVoice_ComputeParamAddr (v7 addr)

	.byte 0xc1, 0x6d, 0x32, 0x3c, 0xfc	; anddi8 (0x3309), 252 (v7 patched)
...
AccCh1_SetReady:
	.byte 0xc1, 0x45, 0x33, 0x3e, 0x01	; ordi8 0x33e1, 1 (v7 patched)
...
AccSeq_PatternScanner:
	.byte 0xd1, 0x3c, 0x33, 0x25	; ldw_d16 xiy, (0x33d8) (v7 patched)

	.byte 0xd1, 0x3a, 0x33, 0x26	; ldw_d16 xiz, (0x33d6) (v7 patched)

	.byte 0xc1, 0x58, 0x32, 0x3c, 0xfe	; anddi8 (0x32f4), 254 (v7 patched)
...
AccAutoPlay_NoteDispatch_Check:
	.byte 0xc1, 0xfc, 0x33, 0x3e, 0x80	; ordi8 0x3498, 128 (v7 patched)
...
AccAutoPlay_Configure_Apply:
	.byte 0xc1, 0xd2, 0x33, 0x3e, 0xe0	; ordi8 0x346e, 224 (v7 patched)
...
AccReplay_FullRestart:
	.byte 0xf1, 0xd8, 0x33, 0x00, 0x00	; stdi8 (0x3474), 0 (v7 patched)

	.byte 0xc1, 0xf5, 0x33, 0x3e, 0x01	; ordi8 0x3491, 1 (v7 patched)

	.byte 0x1e, 0x6a, 0x00	; calr AccPlayMode_WaitIdle (v7 displacement)
...
AccDir_Periodic_DisableAndReset:
	.byte 0xc1, 0xe8, 0x31, 0x3c, 0xef	; anddi8 (0x3284), 239 (v7 patched)

	.byte 0xc1, 0xe8, 0x31, 0x3c, 0xfb	; anddi8 (0x3284), 251 (v7 patched)
...
AccStyle_ModeEnter_SetFlags:
	.byte 0xc1, 0x31, 0x34, 0x3e, 0x08	; ordi8 0x34cd, 8 (v7 patched)

	.byte 0xc1, 0x37, 0x33, 0x3e, 0x01	; ordi8 0x33d3, 1 (v7 patched)

	ldb a, 0x4b

	.byte 0x1d, 0x72, 0x71, 0xfc	; call CtrlPanel_SetIndicatorBit (v7 addr)
...
AccStyle_ModeExit_ClearFlags:
	.byte 0xc1, 0x37, 0x33, 0x3c, 0xfc	; anddi8 (0x33d3), 252 (v7 patched)

	.byte 0x1d, 0x75, 0x83, 0xf9	; call PartSelect_UpdateDisplayState (v7 addr)
...
AccDemo_Init_ConfigTimers:
	.byte 0xc1, 0x35, 0x34, 0x3c, 0x7f	; anddi8 (0x34d1), 127 (v7 patched)

	.byte 0xf1, 0x1a, 0x39, 0x00, 0x00	; stdi8 (0x39b6), 0 (v7 patched)

	.byte 0xf1, 0x1b, 0x39, 0x00, 0x0a	; stdi8 (0x39b7), 10 (v7 patched)
...
AccPatch_InitCurrentSlotPointer:
	.byte 0x1e, 0x05, 0x02	; calr AccPatch_GetCurrentSlotAddr (v7 displacement)

	.byte 0xc1, 0xff, 0x36, 0x21	; ldb_d8 a, (0x379b) (v7 patched)

	.byte 0x1e, 0x91, 0x06	; calr MapBitFlagsToChannelOffset (v7 displacement)
...
AccPatch_InitCurrentSlot:
	.byte 0x1e, 0xa4, 0xff	; calr AccPatch_GetCurrentSlotAddr (v7 displacement)

	.byte 0x1e, 0xe4, 0x00	; calr AccPatch_FreeAllChains (v7 displacement)

	.byte 0x1e, 0x86, 0x01	; calr AccPatch_CopyDefaultsForInit (v7 displacement)

	.byte 0x1e, 0x2d, 0x01	; calr AccPatch_FillAllVoiceData (v7 displacement)

	.byte 0xc1, 0x31, 0x34, 0x3e, 0x80	; ordi8 0x34cd, 128 (v7 patched)

	.byte 0x1e, 0xca, 0x11	; calr AccPatch_ScanToSequenceStart (v7 displacement)
...
AccPatch_SetVoiceAndInit:
	.byte 0x1e, 0x4d, 0xfd	; calr AccPatch_GetCurrentSlotAddr (v7 displacement)

	.byte 0xc1, 0x3c, 0x34, 0x21	; ldb_d8 a, (0x34d8) (v7 patched)
...
AccPatch_SetRepeatBitOn:
	.byte 0xc1, 0x37, 0x34, 0x3e, 0x01	; ordi8 0x34d3, 1 (v7 patched)
...
AccPatch_ResumeSequencePlayback:
	.byte 0xc1, 0x61, 0x35, 0x3c, 0xfe	; anddi8 (0x35fd), 254 (v7 patched)

	.byte 0x1e, 0xb3, 0x00	; calr AccPatch_PrepareSequencePlayback (v7 displacement)

	.byte 0xd1, 0x42, 0x35, 0x20	; ldw_d16 xwa, (0x35de) (v7 patched)

	.byte 0xf1, 0x76, 0x35, 0x50	; stda16 (0x3612), xwa (v7 patched)

	.byte 0xd1, 0x44, 0x35, 0x20	; ldw_d16 xwa, (0x35e0) (v7 patched)

	.byte 0xf1, 0x78, 0x35, 0x50	; stda16 (0x3614), xwa (v7 patched)

	.byte 0xf1, 0x6e, 0x35, 0x02, 0x00, 0x00	; stdi16 (0x360a), 0 (v7 patched)
...
AccPlayback_ReadEventLoop:
	.byte 0xc1, 0x34, 0x34, 0x3c, 0x7f	; anddi8 (0x34d0), 127 (v7 patched)
...
AccPatch_LoadDualVoiceParamsB:
	.byte 0xe1, 0xc4, 0x34, 0x25	; ldda32 xiy, (0x3560) (v7 patched)
...
AccFill_ProcessEntry:
	.byte 0xc1, 0x14, 0x35, 0x3e, 0x04	; ordi8 0x35b0, 4 (v7 patched)

	.byte 0xf1, 0xfa, 0x34, 0x52	; stda16 (0x3596), xde (v7 patched)
...
RhythmPatInit_Cleanup:
	.byte 0xc1, 0x1c, 0xe3, 0x3c, 0x9e	; anddi8	(0xe3e2), 158 (v7 patched)
...
StylCnv_Type2_CheckSoundMem:
	.byte 0xc1, 0x9a, 0x8c, 0x3f, 0x16	; cpdi8 (0x8d36), 22 (v7 patched)

	.byte 0x7e, 0xc9, 0x08	; jrl nz, StylCnv_Epilogue114 (v7 displacement)
