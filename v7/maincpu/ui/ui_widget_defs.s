...
PsTrkSw_Confirm_DrawGeometry:
	...
	ldw wa, 0xcb
	call GetClientBox2
	stb_dri E, 0xfd, 0x9e, 0x00
	stb_dri D, 0xfd, 0x96, 0x00
	lds bc, 4
	ldirw
	stb_dri D, 0xfd, 0x8e, 0x00
	stb_dri W, 0xfd, 0x9e, 0x00
	ld bc, (xwa)
	ld (xix), bc
	stb_dri E, 0xfd, 0x8a, 0x00
	ld bc, (xwa + 4)
	ld (xiy), bc
	lda xhl, (xwa + 6)
	ld de, (xwa + 2)
